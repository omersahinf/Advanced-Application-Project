...
export const routes: Routes = [
  ...
  },
  {
    path: 'dashboard',
    canActivate: [roleGuard('INDIVIDUAL')],
    loadComponent: () => import('./components/individual-dashboard/individual-dashboard').then(m => m.IndividualDashboardComponent)
  },
  {
    path: 'orders',
    canActivate: [roleGuard('INDIVIDUAL')],
  ...
  },
  {
    path: 'reviews',
    canActivate: [roleGuard('INDIVIDUAL')],
    loadComponent: () => import('./components/my-reviews/my-reviews').then(m => m.MyReviewsComponent)
  },
  ...
  },
  {
    path: 'admin/stores',
    canActivate: [roleGuard('ADMIN')],
    loadComponent: () => import('./components/admin-stores/admin-stores').then(m => m.AdminStoresComponent)
  },
  {
  ...
  },
  {
    ...
    canActivate: [roleGuard('ADMIN')],
    loadComponent: () => import('./components/admin-analytics/admin-analytics').then(m => m.AdminAnalyticsComponent)
  },
  ...
  // Corporate
  {
    ...
    loadComponent: () => import('./components/corporate-dashboard/corporate-dashboard').then(m => m.CorporateDashboardComponent)
  },
  {
    path: 'corporate/products',
    canActivate: [roleGuard('CORPORATE')],
    loadComponent: () => import('./components/corporate-products/corporate-products').then(m => m.CorporateProductsComponent)
  },
  {
    path: 'corporate/orders',
    canActivate: [roleGuard('CORPORATE')],
    loadComponent: () => import('./components/corporate-orders/corporate-orders').then(m => m.CorporateOrdersComponent)
  },
  {
    path: 'corporate/reviews',
    canActivate: [roleGuard('CORPORATE')],
    loadComponent: () => import('./components/corporate-reviews/corporate-reviews').then(m => m.CorporateReviewsComponent)
  },
